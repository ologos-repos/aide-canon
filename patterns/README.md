...
| [mxh-p-synthesis.md](mxh-p-synthesis.md) | Proposed (see [ADR-EA-0028](../decisions/ADR-EA-0028-introduce-mxh-p-synthesis-pattern.md)) | **MxH-P** — compose MxM (orient/constrain) · Hermetic (swarm schedule/coordinate) · P/G/E (claimable plan→build→skeptical accept). Orientation packet, signal/gate P/G/E, unified oracle×morals escalation; partial labels `core` / `swarm` / `full`. Supertype: workflow-orchestration; Hermetic stays Pattern B+. |
