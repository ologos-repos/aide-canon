...
| [ADR-EA-0023](ADR-EA-0023-thinx-discipline-refinements.md) | Three reference-impl-derived discipline refinements (founder-override pattern + Governed Context Management §8 + EIF §6 operationalization) | Proposed |
