...
| **[mxh-p](https://github.com/ologos-repos/mxh-p)** | Pattern B+ **MxH-P/core** kernel for [MxH-P synthesis](../../../patterns/mxh-p-synthesis.md) ([ADR-EA-0028](../../../decisions/ADR-EA-0028-introduce-mxh-p-synthesis-pattern.md)) — orientation packet, P/G/E gate, profiles; out-of-tree | *(cite only; tracking folder optional later)* |
