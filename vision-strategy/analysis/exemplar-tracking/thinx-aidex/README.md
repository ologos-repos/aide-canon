...
| **AIDEX** artifact production (≈ NG-AIDE-01 α1/KR4.3) | **Productivity Console** (`docs/productivity-console.md`, design v0.1 2026-06-01): brief → **FOrCE artifact-producer** agent (thinx's `means/agents`) → render → QA → approve → archive; Anthropic Agent-Skills architecture (route → skill → generator); template-first brand; provenance sidecar | **synonym (operator-altitude)** — a working instance of the α1 skills substrate; see § below |
