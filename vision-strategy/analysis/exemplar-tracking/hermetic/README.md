...
| **MxH-P** ([pattern](../../../patterns/mxh-p-synthesis.md)) | Hermetic as **swarm schedule/coordinate** altitude under MxM orientation packets + optional P/G/E signal/gate packages | Pattern **Accepted** ([ADR-EA-0028](../../../decisions/ADR-EA-0028-introduce-mxh-p-synthesis-pattern.md)); Hermetic is the multi-worker means fragment — not a substitute for MxM or claimable P/G/E |
